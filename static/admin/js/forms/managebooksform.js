...
Array('input', 'focusin').forEach((evt) => {
    ...
    BOOK_TITLE.addEventListener(evt, function () {
        vc.setValidity(this, this, PURPOSE.TITLE, PURPOSE.TITLE.constraint(this.value));
    });
    ...
    ISBN.addEventListener(evt, function () {
        vc.setValidity(this, this, PURPOSE.ISBN, PURPOSE.ISBN.constraint(this.value));
    });
    PUBLISHER.addEventListener(evt, function () {
        vc.setValidity(this, this, PURPOSE.PUBLISHER, PURPOSE.PUBLISHER.constraint(this.value));
    });
});
